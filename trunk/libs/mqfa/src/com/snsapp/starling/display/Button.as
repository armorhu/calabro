...
package com.snsapp.starling.display
{
	...
	public class Button extends DisplayObjectContainer
	{
		...
		private var mUpState:SingleTexture;
		private var mDownState:SingleTexture;
		...
		public function Button(upState:SingleTexture, text:String = "", downState:SingleTexture = null)
		{
			if (upState == null)
			...
			mBackground = StarlingFactory.newImage(upState);
		...
		{
			mIsDown = false;
			StarlingFactory.setTexture(mBackground, upState);
		...
		private function onTouch(event:TouchEvent):void
		{
			...
			{
				StarlingFactory.setTexture(mBackground, downState);
		...
		public function get upState():SingleTexture
		{
			return mUpState;
		}

		public function set upState(value:SingleTexture):void
		{
			if (mUpState != value)
			{
				mUpState = value;
				if (!mIsDown)
				{
					StarlingFactory.setTexture(mBackground, value);
				}
			}
		}

		/** The texture that is displayed while the button is touched. */
		public function get downState():SingleTexture
		{
			return mDownState;
		}

		public function set downState(value:SingleTexture):void
		{
			if (mDownState != value)
			{
				mDownState = value;
