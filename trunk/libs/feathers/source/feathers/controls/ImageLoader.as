		...
		protected function commitData():void
		{
			...
			else
			{
				...
				else
				{
					...
					req.requestHeaders.push(new URLRequestHeader("Referer", "http://appbase.qzone.qq.com/cgi-bin/index/appbase_run_unity.cgi?appid=353&max=0&qz_height=600&qz_width=760&qz_ver=6&appcanvas=1&via=QZ.MYAPP"));
					this.loader.load(req, LOADER_CONTEXT);
				}
			}
		}
